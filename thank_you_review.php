...
<body>
        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p>Thank you for leaving a review! It is highly appreciated. Hope you liked our service and will be visiting again.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script src="client_login_script.js"></script>
</body>
</html>
