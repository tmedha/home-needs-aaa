    ...
    <div>
      ...
      <div class = "row">
        ...
        <ul class="list-group list-group-flush">
          <li class="list-group-item">Service 1 <div class="servicebuttons"><a href="services.php" class="btn btn-custom">Book Now</a><a href="cart.php" class="btn btn-custom2">Add to Cart</a></div></li> 
          <li class="list-group-item">Service 2 <div class="servicebuttons"><a href="services.php" class="btn btn-custom">Book Now</a><a href="cart.php" class="btn btn-custom2">Add to Cart</a></div></li>
          <li class="list-group-item">Service 3 <div class="servicebuttons"><a href="services.php" class="btn btn-custom">Book Now</a><a href="cart.php" class="btn btn-custom2">Add to Cart</a></div></li>
          <li class="list-group-item">Service 4 <div class="servicebuttons"><a href="services.php" class="btn btn-custom">Book Now</a><a href="cart.php" class="btn btn-custom2">Add to Cart</a></div></li>
          <li class="list-group-item">Service 5 <div class="servicebuttons"><a href="services.php" class="btn btn-custom">Book Now</a><a href="cart.php" class="btn btn-custom2">Add to Cart</a></div></li>
        </ul>
        </div>
        <div class="col">
          <h3>About Us</h3>
